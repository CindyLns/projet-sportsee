    ...
    return (
        <div className='keyData'>
            ...
            <div className='keyData-content'>
                ...
                <div className='keyData-information'>
                    <span className='keyData-number'>{datas?.keyData?.calorieCount}kCal</span>
            ...
            <div className='keyData-content'>
                ...
                <div className='keyData-information'>
                    <span className='keyData-number'>{datas?.keyData?.proteinCount}g</span>
            ...
            <div className='keyData-content'>
                ...
                <path d="M22.8428 35.1C23.2753 36.0575 23.4816 36.485 24.0391 37.3313C24.8153 38.5125 25.9091 39.985 27.2653 39.9975C28.4703 40.0088 28.7803 39.2138 30.4153 39.2225C32.0503 39.2313 32.3928 40.0113 33.5978 40C34.9541 39.9875 35.9903 38.6588 36.7678 37.4763C38.9378 34.1713 39.1653 30.2938 37.8266 28.2325C36.8753 26.7663 35.3741 25.91 33.9616 25.91C32.5241 25.91 31.6216 26.6975 30.4328 26.6975C29.2803 26.6975 28.5778 25.9088 26.9153 25.9088C25.6591 25.9088 24.3278 26.5925 23.3803 27.7738C26.4866 29.4775 25.9816 33.9138 22.8428 35.1Z" fill="#FDCC0C"/>
                <path d="M33.005 23.3737C33.6875 22.4987 34.205 21.2625 34.0162 20C32.9025 20.0763 31.6 20.785 30.8387 21.7088C30.1487 22.5475 29.5787 23.7912 29.8 25C31.0162 25.0375 32.2737 24.3112 33.005 23.3737Z" fill="#FDCC0C"/>
                </svg>
                <div className='keyData-information'>
                    <span className='keyData-number'>{datas?.keyData?.carbohydrateCount}g</span>
            ...
            <div className='keyData-content'>
                ...
                <div className='keyData-information'>
                    <span className='keyData-number'>{datas?.keyData?.lipidCount}g</span>
                    <p className='keyData-subtitle'>Lipides</p>
                </div>
            </div>
